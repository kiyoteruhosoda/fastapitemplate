...
SYSTEM_SETTING_DEFINITIONS: list[dict[str, object]] = [
    ...
    # --- 二要素認証（TOTP） ---
    {"key": "TOTP_ISSUER", "category": "two_factor",
     "label": "Issuer shown in authenticator apps", "value_type": "string"},
    {"key": "TOTP_VALID_WINDOW", "category": "two_factor",
     "label": "Accepted time-step drift", "value_type": "integer"},
    # --- パスキー（WebAuthn） ---
    {"key": "WEBAUTHN_RP_ID", "category": "passkey",
     "label": "Relying party ID (domain)", "value_type": "string"},
    {"key": "WEBAUTHN_RP_NAME", "category": "passkey",
     "label": "Relying party name", "value_type": "string"},
    {"key": "WEBAUTHN_ORIGIN", "category": "passkey",
     "label": "Expected browser origin", "value_type": "string"},
    {"key": "WEBAUTHN_CHALLENGE_TTL_SECONDS", "category": "passkey",
     "label": "Challenge lifetime (seconds)", "value_type": "integer"},
    # --- 一般 ---
    {"key": "APP_BASE_URL", "category": "general",
     "label": "Application base URL", "value_type": "string"},
    {"key": "LANGUAGES", "category": "general",
     "label": "Selectable languages", "value_type": "list"},
    {"key": "DEFAULT_LOCALE", "category": "general",
     "label": "Default locale", "value_type": "string",
     "choices": [["en", "English"], ["ja", "日本語"]]},
    {"key": "DEFAULT_THEME", "category": "general",
     "label": "Default theme", "value_type": "string",
